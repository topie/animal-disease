...
<table class="t1">
    ...
    <tr class="r6">
        ...
        <td class="c2" colspan="8">秋防期间存栏数量（万头/只/羽）</td>
        <td class="c2" colspan="4">秋防期间牲畜口蹄疫应免数量（万头/只）</td>
        <td class="c10" colspan="4">秋防期间禽流感应免数量（万羽）</td>
        <td class="c2" colspan="4">秋防期间A型口蹄疫应免数量（万头）</td>
        <td class="c2">秋防期间高致病性猪蓝耳病应免数量（万头）</td>
        <td class="c2">秋防期间猪瘟应免数量（万头）</td>
        <td class="c2">秋防期间新城疫应免数量（万羽）</td>
