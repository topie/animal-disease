...
<body class="b1">
	...
	<table class="t1">
		...
		<tbody>
			...
			<tr class="r2">
				<td class="c2">填表日期:</td>
				<td class="c3" colspan="18"><#if report.reportTime??>${report.reportTime?string("yyyy-MM-dd")}</#if></td>
			</tr>
			<tr class="r2">
			...
			<tr class="r4">
				...
				<td class="c2" colspan="4">全省秋防落实动物疫病防控经费（万元）</td>
				<td class="c2" colspan="4">省本级秋防落实动物疫病防控经费（万元）</td>
			</tr>
			<tr class="r5">
