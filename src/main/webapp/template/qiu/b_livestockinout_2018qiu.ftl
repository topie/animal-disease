...
<table class="t1">
    ...
    <tr class="r2">
        <td class="c2">填表日期:</td>
        <td class="c3" colspan="27"><#if report.reportTime??>${report.reportTime?string("yyyy-MM-dd")}</#if></td>
    </tr>
    <tr class="r3">
    ...
    <tr class="r2">
        <td class="c2">主管领导：</td>
        <td class="c3" colspan="27">${user.leaderName}</td>
    </tr>
    <tr class="r4">
        <td class="c2">&nbsp;</td>
        ...
        <td class="c2" colspan="4">A型口蹄疫当月应免数量（万头）</td>
    ...
    <tr class="r5">
        ...
        <td role="data" n="immuneafmdzhu" class="c2"><#if item.immuneafmdzhu??>${item.immuneafmdzhu}</#if></td>
        ...
        <td role="data" n="immuneafmdother" class="c2"><#if item.immuneafmdother??>${item.immuneafmdother}</#if></td>
        ...
        <td role="data" n="immuneaPprSheep" class="c2"><#if item.immuneaPprSheep??>${item.immuneaPprSheep}</#if></td>
    ...
    <tr class="r5">
        <td class="c2">填表说明</td>
        <td class="c2" colspan="27">应免数量指的是免疫该类疫苗的动物数量</td>
