	...
	<table class="t1">
		...
		<tbody>
            ...
            <tr class="r6">
                ...
                <td role="data"  n="fmdOavaccine"  class="c9"><#if item.fmdOavaccine??>${item.fmdOavaccine}</#if></td>
                <td role="lj_fmdOavaccine" class="c7"><#if itemSum.fmdOavaccine??>${itemSum.fmdOavaccine}</#if></td>
                <td role="data"  n="fmdOaimmuneamountzhu"  class="c9"><#if item.fmdOaimmuneamountzhu??>${item.fmdOaimmuneamountzhu}</#if></td>
                <td role="data"  n="fmdOaimmuneamountniu"  class="c2"><#if item.fmdOaimmuneamountniu??>${item.fmdOaimmuneamountniu}</#if></td>
                <td role="data"  n="fmdOaimmuneamountsheep"  class="c9"><#if item.fmdOaimmuneamountsheep??>${item.fmdOaimmuneamountsheep}</#if></td>
                <td role="data"  n="fmdOaimmuneamountother"  class="c9"><#if item.fmdOaimmuneamountother??>${item.fmdOaimmuneamountother}</#if></td>
                <td role="lj_fmdOaimmuneamountzhu" class="c7"><#if itemSum.fmdOaimmuneamountzhu??>${itemSum.fmdOaimmuneamountzhu}</#if></td>
                <td role="lj_fmdOaimmuneamountniu" class="c7"><#if itemSum.fmdOaimmuneamountniu??>${itemSum.fmdOaimmuneamountniu}</#if></td>
                <td role="lj_fmdOaimmuneamountsheep" class="c7"><#if itemSum.fmdOaimmuneamountsheep??>${itemSum.fmdOaimmuneamountsheep}</#if></td>
                <td role="lj_fmdOaimmuneamountother" class="c7"><#if itemSum.fmdOaimmuneamountother??>${itemSum.fmdOaimmuneamountother}</#if></td>
                <input id="fmdOavaccine" type="hidden" value="${itemSum.fmdOavaccine?default(0)-item.fmdOavaccine?default(0)}"/>
                <input id="fmdOaimmuneamountzhu" type="hidden" value="${itemSum.fmdOaimmuneamountzhu?default(0)-item.fmdOaimmuneamountzhu?default(0)}"/>
                <input id="fmdOaimmuneamountniu" type="hidden" value="${itemSum.fmdOaimmuneamountniu?default(0)-item.fmdOaimmuneamountniu?default(0)}"/>
                <input id="fmdOaimmuneamountsheep" type="hidden" value="${itemSum.fmdOaimmuneamountsheep?default(0)-item.fmdOaimmuneamountsheep?default(0)}"/>
                <input id="fmdOaimmuneamountother" type="hidden" value="${itemSum.fmdOaimmuneamountother?default(0)-item.fmdOaimmuneamountother?default(0)}"/>
            </tr>
			<tr class="r7">
				...
				<td role="data" n="fmdO3immuneamountpig"   class="c2"><#if item.fmdO3immuneamountpig??>${item.fmdO3immuneamountpig}</#if></td>
				...
				<td role="data" n="fmdO3immuneamountother"  class="c10"><#if item.fmdO3immuneamountother??>${item.fmdO3immuneamountother}</#if></td>
				<td role="lj_fmdO3immuneamountpig" class="c7"><#if itemSum.fmdO3immuneamountpig??>${itemSum.fmdO3immuneamountpig}</#if></td>
                ...
                <td role="lj_fmdO3immuneamountother" class="c7"><#if itemSum.fmdO3immuneamountother??>${itemSum.fmdO3immuneamountother}</#if></td>
                <input id="fmdO3vaccine" type="hidden" value="${itemSum.fmdO3vaccine?default(0)-item.fmdO3vaccine?default(0)}"/>
                <input id="fmdO3immuneamountpig" type="hidden" value="${itemSum.fmdO3immuneamountpig?default(0)-item.fmdO3immuneamountpig?default(0)}"/>
				...
				<input id="fmdO3immuneamountother" type="hidden" value="${itemSum.fmdO3immuneamountother?default(0)-item.fmdO3immuneamountother?default(0)}"/>
			</tr>
			<tr class="r8">
				...
				<td role="data" n="fmdAimmuneamountzhu"  class="c2"><#if item.fmdAimmuneamountzhu??>${item.fmdAimmuneamountzhu}</#if></td>
                ...
                <td role="data" n="fmdAimmuneamountother"  class="c11"><#if item.fmdAimmuneamountother??>${item.fmdAimmuneamountother}</#if></td>
				<td role="lj_fmdAimmuneamountzhu" class="c7"><#if itemSum.fmdAimmuneamountzhu??>${itemSum.fmdAimmuneamountzhu}</#if></td>
                ...
                <td role="lj_fmdAimmuneamountother" class="c7"><#if itemSum.fmdAimmuneamountother??>${itemSum.fmdAimmuneamountother}</#if></td>
                <input id="fmdAvaccine" type="hidden" value="${itemSum.fmdAvaccine?default(0)-item.fmdAvaccine?default(0)}"/>
                <input id="fmdAimmuneamountzhu" type="hidden" value="${itemSum.fmdAimmuneamountzhu?default(0)-item.fmdAimmuneamountzhu?default(0)}"/>
				...
				<input id="fmdAimmuneamountother" type="hidden" value="${itemSum.fmdAimmuneamountother?default(0)-item.fmdAimmuneamountother?default(0)}"/>
			</tr>
			<tr class="r3">
...
<script type="text/javascript">
    (function ($, window, document, undefined) {
        ...
        var calculate = function () {
            ...
            $("td[role=lj_fmdOavaccine]").text((parseFloat(lj_fmdOavaccine)+parseFloat(fmdOavaccine)).toFixed(2));
            $("td[role=lj_fmdOaimmuneamountzhu]").text((parseFloat(lj_fmdOaimmuneamountzhu)+parseFloat(fmdOaimmuneamountzhu)).toFixed(2));
            $("td[role=lj_fmdOaimmuneamountniu]").text((parseFloat(lj_fmdOaimmuneamountniu)+parseFloat(fmdOaimmuneamountniu)).toFixed(2));
            $("td[role=lj_fmdOaimmuneamountsheep]").text((parseFloat(lj_fmdOaimmuneamountsheep)+parseFloat(fmdOaimmuneamountsheep)).toFixed(2));
            $("td[role=lj_fmdOaimmuneamountother]").text((parseFloat(lj_fmdOaimmuneamountother)+parseFloat(fmdOaimmuneamountother)).toFixed(2));
            ...
            $("td[role=lj_fmdO3immuneamountpig]").text((parseFloat(lj_fmdO3immuneamountpig)+parseFloat(fmdO3immuneamountpig)).toFixed(2));
			...
			$("td[role=lj_fmdO3immuneamountother]").text((parseFloat(lj_fmdO3immuneamountother)+parseFloat(fmdO3immuneamountother)).toFixed(2));
            ...
            $("td[role=lj_fmdAimmuneamountzhu]").text((parseFloat(lj_fmdAimmuneamountzhu)+parseFloat(fmdAimmuneamountzhu)).toFixed(2));
        	...
        	$("td[role=lj_fmdAimmuneamountother]").text((parseFloat(lj_fmdAimmuneamountother)+parseFloat(fmdAimmuneamountother)).toFixed(2));
        }
