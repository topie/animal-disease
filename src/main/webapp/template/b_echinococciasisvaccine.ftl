...
<table class="t1">
    ...
    <tr class="r2">
        <td class="c2">填表日期:</td>
        <td class="c4" colspan="9"><#if item.echDate??>${item.echDate?string("yyyy-MM-dd")}</#if></td>
    </tr>
    <tr class="r2">
        <td class="c2">填 表 人:</td>
        <td class="c4" colspan="9">${user.realName}</td>
    </tr>
    <tr class="r2">
        <td class="c2">主管领导：</td>
        <td class="c4" colspan="9">${user.leaderName}</td>
        <td class="c5">&nbsp;</td>
    </tr>
    <tr class="r3">
