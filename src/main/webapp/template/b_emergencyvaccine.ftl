...
<table class="t1">
    ...
    <tr class="r2">
        <td class="c2">单   位</td><td class="c2" colspan="3">${org.orgName}</td>
    </tr>
    <tr class="r2">
        <td class="c3">填表日期</td><td class="c3" colspan="3"><#if item.evDate??>${item.evDate?string("yyyy-MM-dd")}</#if></td>
    </tr>
    <tr class="r2">
        <td class="c3">填 表 人</td><td class="c3" colspan="3">${user.realName}</td>
    </tr>
    <tr class="r2">
        <td class="c3">主管领导</td><td class="c3" colspan="3">${user.leaderName}</td>
    </tr>
    <tr class="r2">
