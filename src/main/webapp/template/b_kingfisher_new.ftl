...
<head>
    ...
    .c3{white-space:pre-wrap;text-align:left;border-top:thin solid black;border-right:thin solid black;border-bottom:thin solid black;border-left:thin solid black;font-size:12pt;}
    </style>
</head>
<body class="b1">
<table class="t1">
    ...
    <tr class="r2">
        <td class="c2">单   位:</td>
        <td class="c2" colspan="14">${org.orgName}</td>
    </tr>
    <tr class="r2">
        <td class="c2">填表日期:</td>
        <td class="c2" colspan="14"><#if item.kfDate??>${item.kfDate?string("yyyy-MM-dd")}</#if></td>
    </tr>
    <tr class="r2">
        <td class="c2">填 表 人:</td>
        <td class="c2" colspan="14">${user.realName}</td>
    </tr>
    <tr class="r3">
        <td class="c2">主管领导：</td>
