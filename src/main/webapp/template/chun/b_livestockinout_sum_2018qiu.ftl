...
<table class="t1">
    ...
    <tr class="r2">
        ...
        <td class="c2" colspan="4">A型口蹄疫当月应免数量(万头/只)</td>
    ...
    <#assign immuneafmdzhuSum=0>
    <#assign immuneafmdniuSum=0>
    <#assign immuneafmdsheepSum=0>
    <#assign immuneafmdotherSum=0>
    ...
    <#list items as item>
        ...
        <#assign immuneafmdzhuSum=immuneafmdzhuSum?default(0) +item.immuneafmdzhu?default(0)>
        ...
        <#assign immuneafmdotherSum=immuneafmdotherSum?default(0) +item.immuneafmdother?default(0)>
    ...
    <tr class="r3">
        ...
        <td n="immuneafmdzhu" class="c2"><#if item.immuneafmdzhu??>${item.immuneafmdzhu}</#if></td>
        ...
        <td n="immuneafmdother"
            class="c2"><#if item.immuneafmdother??>${item.immuneafmdother}</#if></td>
    ...
    <tr class="r3">
        ...
        <td n="immuneafmdzhuSum" class="c2"><#if immuneafmdzhuSum??>${immuneafmdzhuSum}</#if></td>
        ...
        <td n="immuneafmdotherSum" class="c2"><#if immuneafmdotherSum??>${immuneafmdotherSum}</#if></td>
