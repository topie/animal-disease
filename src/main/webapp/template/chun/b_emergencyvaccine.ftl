...
<table class="t1">
    ...
    <tbody>
    <tr class="r1">
        <td class="c3" colspan="4">${templateName}</td>
    </tr>
    <tr class="r2">
        <td class="c2">单   位</td><td class="c4" colspan="3">${org.orgName}</td>
    </tr>
    <tr class="r2">
        <td class="c3">填表日期</td><td class="c4" colspan="3"><#if report.reportTime??>${report.reportTime?string("yyyy-MM-dd")}</#if></td>
    </tr>
    <tr class="r2">
        <td class="c3">填 表 人</td><td class="c4" colspan="3">${user.realName}</td>
    </tr>
    <tr class="r2">
        <td class="c3">主管领导</td><td class="c4" colspan="3">${user.leaderName}</td>
    </tr>
    <tr class="r2">
        <td class="c3" colspan="2">疫苗种类</td><td class="c3">省级存储数量</td><td class="c3">全省存储数量</td>
    </tr>
    <tr class="r3">
    ...
    <tr class="r5">
        <td class="c3" >备注</td>
        <td role="note"  colspan="3" n="bz" class="c3">${item.bz}</td>
    </tr>
    </tbody>
</table>
</body>
