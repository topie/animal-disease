...
<table class="t1">
    ...
    <tr class="r7">
        ...
        <td role="data" n="avRe6re7usecount" class="c2"><#if item.avRe6re7usecount??>${item.avRe6re7usecount}</#if></td>
        <td role="data" n="avRe6re8usecount" class="c2"><#if item.avRe6re8usecount??>${item.avRe6re8usecount}</#if></td>
        ...
        <td role="data" n="avRe6re7storecount" class="c2"><#if item.avRe6re7storecount??>${item.avRe6re7storecount}</#if></td>
        <td role="data" n="avRe6re8storecount" class="c2"><#if item.avRe6re8storecount??>${item.avRe6re8storecount}</#if></td>
        ...
        <td role="data" n="avRe6re7yearcount" class="c2"><#if item.avRe6re7yearcount??>${item.avRe6re7yearcount}</#if></td>
        <td role="data" n="avRe6re8yearcount" class="c2"><#if item.avRe6re8yearcount??>${item.avRe6re8yearcount}</#if></td>
        <td role="data" n="avRe6re7re8yearcount" class="c2"><#if item.avRe6re7re8yearcount??>${item.avRe6re7re8yearcount}</#if></td>
        <td role="data" n="avH5n2d7yearcount" class="c2"><#if item.avH5n2d7yearcount??>${item.avH5n2d7yearcount}</#if></td>
