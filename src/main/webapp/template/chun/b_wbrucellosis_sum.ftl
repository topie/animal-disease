	...
	<table class="t1">
		...
		<tbody>
			...
			<tr class="r2">
				...
				<td class="c2" colspan="7">布氏菌病活疫苗(S2株)</td>
				<td class="c2" colspan="7">布氏菌病活疫苗(A19株)</td>
                <td class="c2" colspan="7">布氏菌病活疫苗(M5株)</td>
				<td class="c2" rowspan="2" colspan="3">应免数量</td>
				<td class="c2" rowspan="2" colspan="3">免疫进展</td>
			</tr>
			<tr class="r3">
			...
			<#assign bruS2immuneamount_ljSum=0>
			<#assign bruA19immuneamount_ljSum=0>
			<#assign bruM5immuneamount_ljSum=0>

			<#assign immuneBru_ljSum=0>
			...
			<#list items as item>
				...
				<#assign bruS2immuneamount_ljSum=bruS2sheepimmuneamount_ljSum+bruS2niuimmuneamount_ljSum>
				...
				<#assign bruA19immuneamount_ljSum=bruA19niuimmuneamount_ljSum+bruA19sheepimmuneamount_ljSum>
				...
				<#assign bruM5immuneamount_ljSum=bruM5niuimmuneamount_ljSum+bruM5sheepimmuneamount_ljSum>
				<#assign immuneBru_ljSum=immuneBruSheep_ljSum +immuneBruniu_ljSum>
			...
			<tr class="r4">
                ...
                <td class="c2"><#if cumulatives[item_index]??>${cumulatives[item_index].bruS2niuimmuneamount?default(0)+cumulatives[item_index].bruS2sheepimmuneamount?default(0)}</#if></td>
                ...
                <td class="c2"><#if cumulatives[item_index]??>${cumulatives[item_index].bruA19niuimmuneamount?default(0)+cumulatives[item_index].bruA19sheepimmuneamount?default(0)}</#if></td>
                ...
                <td class="c2"><#if cumulatives[item_index]??>${cumulatives[item_index].bruM5niuimmuneamount?default(0)+cumulatives[item_index].bruM5sheepimmuneamount?default(0)}</#if></td>
                ...
                <td class="c2"><#if wlivestockinouts[item_index]??>${wlivestockinouts[item_index].immuneBruniu?default(0)+wlivestockinouts[item_index].immuneBruSheep?default(0)}</#if></td>
                <td class="c2">
                ...
                <td class="c2">
					<#if cumulatives[item_index]??&& wlivestockinouts[item_index]??&&(wlivestockinouts[item_index].immuneBruniu?default(0)+wlivestockinouts[item_index].immuneBruSheep?default(0)>0)>
					${(cumulatives[item_index].bruS2niuimmuneamount?default(0)+cumulatives[item_index].bruA19niuimmuneamount?default(0)+cumulatives[item_index].bruM5niuimmuneamount?default(0)+cumulatives[item_index].bruS2sheepimmuneamount?default(0)+cumulatives[item_index].bruA19sheepimmuneamount?default(0)+cumulatives[item_index].bruM5sheepimmuneamount?default(0))*100
					/(wlivestockinouts[item_index].immuneBruniu?default(0)+wlivestockinouts[item_index].immuneBruSheep?default(0))
					}%
					</#if>
				</td>
			</tr>
            ...
            <tr class="r4">
                ...
                <td n="bruS2immuneamount_ljSum" class="c2"><#if bruS2immuneamount_ljSum??>${bruS2immuneamount_ljSum}</#if></td>
                ...
                <td n="bruA19immuneamount_ljSum" class="c2"><#if bruA19immuneamount_ljSum??>${bruA19immuneamount_ljSum}</#if></td>
                ...
                <td n="bruM5immuneamount_ljSum" class="c2"><#if bruM5immuneamount_ljSum??>${bruM5immuneamount_ljSum}</#if></td>
                ...
                <td n="immuneBru_ljSum" class="c2"><#if immuneBru_ljSum??>${immuneBru_ljSum}</#if></td>
                ...
                <td  class="c2"><#if (immuneBru_ljSum>0)>${(bruS2immuneamount_ljSum?default(0)+bruM5immuneamount_ljSum?default(0)+bruA19immuneamount_ljSum?default(0))*100/immuneBru_ljSum}%</#if></td>
            </tr>
		</tbody>
	</table>
</body>
