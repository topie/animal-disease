...
<table class="t1">
    ...
    <tr class="r2">
        <td class="c2">单 位:</td>
        <td class="c5" colspan="8">${org.orgName}</td>
    </tr>
    <tr class="r2">
        <td class="c2">填表日期:</td>
        <td class="c5" colspan="8"><#if report.reportTime??>${report.reportTime?string("yyyy-MM-dd")}</#if></td>
    </tr>
    <tr class="r3">
        <td class="c2">填 表 人:</td>
        <td class="c5" colspan="8">${user.realName}</td>
    </tr>
    <tr class="r2">
        <td class="c2">主管领导：</td>
        <td class="c5" colspan="8">${user.leaderName}</td>
    </tr>
    <tr class="r4">
    ...
    <tr class="r5">
        ...
        <td class="c2" colspan="3">上半年使用数量</td>
    </tr>
    <tr class="r6">
