...
<table class="t1">
    ...
    <tr class="r2">
        <td class="c2">填表日期:</td>
        <td class="c3" colspan="10"><#if item.bruDate??>${item.bruDate?string("yyyy-MM-dd")}</#if></td>
    </tr>
    <tr class="r3">
